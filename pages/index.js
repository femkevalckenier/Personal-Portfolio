      ...
      <main className='bg-gradient-to-b from-white to-gray-200 px-10 md:px-20 lg:px-40 dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-900'>
        <section className='min-h-screen'>       
          ...
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-amber-800 font-medium md:text-6xl dark:text-yellow-400'>Femke Valckenier</h2>
            <h3 className='text-2xl py-2 md:text-3xl dark:text-gray-300'>Computer science student.</h3>
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-gray-50'>I currently study at Odisee University College in Brussels. My biggest passions are software and web development. Find out more about me below!</p>
          </div>

          <div className='text-5xl flex justify-center gap-16 py-3 text-gray-700 dark:text-gray-300'>
            <a className=' hover:text-gray-500 hover:ease-in hover:duration-200' href='https://github.com/femkevalckenier'><AiFillGithub /></a>
            <a className=' hover:text-gray-500 hover:ease-in hover:duration-200' href="https://www.linkedin.com/in/femke-valckenier/"><AiFillLinkedin /></a>
            <a className=' hover:text-gray-500 hover:ease-in hover:duration-200' href="https://www.instagram.com/femke_val/"><AiFillInstagram /></a>
          </div>
        ...
        <section>
          ...
          <div className='flex flex-col justify-center items-center mt-5'>
                <form action="https://getform.io/f/9b9d851d-80ce-4db6-b536-d6ac5cd106a0" method="POST" className='flex flex-col w-full md:w-1/2'>
                    <input type="text" name="name" placeholder='Enter your name' className='p-2 bg-transparent placeholder-gray-600 shadow-lg rounded-md text-black focus:outline-none dark:text-white dark:border-white dark:placeholder-white'/>

                    <input type="text" name="email" placeholder='Enter your e-mail' className='my-4 p-2 bg-transparent placeholder-gray-600 shadow-lg rounded-md text-black focus:outline-none dark:text-white dark:border-white dark:placeholder-white'/>
                    ...
                    <button className='mx-auto mt-5 mb-3 font-bold bg-gradient-to-r from-yellow-500 to-amber-600 text-white px-4 py-2 rounded-md dark:text-black hover:scale-105 hover:ease-in hover:duration-200'>Submit</button>
                </form>
            </div>
